...
public class MainStaticObjectControl {
    ...
    public static void openProfileForumStage(Stage currentStage) {
        try {
            Parent profileRoot = FXMLLoader.load(MainStaticObjectControl.class.getResource("/com/example/librabry_management/Forum.fxml"));
            Scene profileScene = new Scene(profileRoot);
